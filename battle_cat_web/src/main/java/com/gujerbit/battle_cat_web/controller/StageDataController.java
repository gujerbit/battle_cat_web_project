...
public class StageDataController {
	...
	@GetMapping("/stage_data/{start}")
	public @ResponseBody List<StageDataVO> getAllStageData(@PathVariable int start) {
		List<StageDataVO> list = service.selectAllStageData(start);
		
		return list;
	}
	
	@GetMapping("/stage_data_size")
	public @ResponseBody int getAllStageDataSize() {
		return service.selectAllStageDataSize();
	}
